...
?>
    ...
    <h1>確認画面</h1>
        ...
        <!-- 記入画面に戻るボタン -->
            <button onclick="history.back(); return false;" value="戻る" class="btn">戻る
        </div>
        <div class="submit_btn">
        <!-- 送信ボタン -->
            <button onclick="location.href='04_completed.php'" value="送信" name="submit" class="btn" id="submit">送信
        </div>
